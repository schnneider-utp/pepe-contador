...
export function SecondaryUploadSection() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      resetForm()
      const fileInput = document.getElementById('secondary-file-upload') as HTMLInputElement
  ...
  return (
    <Card id="secondary-upload-section" className="border-2 hover:border-primary/50 transition-colors">
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        >
          <input type="file" multiple onChange={handleFileChange} className="hidden" id="secondary-file-upload" />
